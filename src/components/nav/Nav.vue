            ...
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex-shrink-0 mb-4">
                        <img class="block h-12 w-auto" src="./../../assets/logo/undraw_weather_app_i5sm.svg" alt="Workflow logo" />
                    </div>
                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex h-full items-center">
                            <router-link class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 transition duration-150 ease-in-out" :to="{ name: 'home' }">Home</router-link>
                            <router-link class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 transition duration-150 ease-in-out" :to="{ name: 'radar' }">Radar</router-link>
                            <router-link class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 transition duration-150 ease-in-out" :to="{ name: 'satellite' }">Satellite</router-link>
                            <router-link class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 transition duration-150 ease-in-out" :to="{ name: 'live' }">Live</router-link>
                        </div>
                    </div>
                </div>
            </div>
